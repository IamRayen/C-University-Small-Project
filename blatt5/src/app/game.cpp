...
void selectTypeAndSendMissile(PlayerSea & currentPlayerSea, PlayerSea & otherPlayerSea, unsigned int round)
{
    ...
    switch (round % 3) {
        ...
        case 2: hit = sendMissile<Missile>(currentPlayerSea, otherPlayerSea); break;
        case 1: hit = sendMissile<TumblingMissile>(currentPlayerSea, otherPlayerSea); break;
        default: hit = sendMissile<DoubleMissile>(currentPlayerSea, otherPlayerSea);
    }
